...
final class AppExecutionRequestTests: XCTestCase {
    func testExternalApplicationMapping() {
        ...
        XCTAssertNil(AppExecutionAction.cutItems.externalApplication)
        XCTAssertNil(AppExecutionAction.openIShot.externalApplication)
        XCTAssertNil(AppExecutionAction.openIShotAnnotation.externalApplication)
        XCTAssertNil(AppExecutionAction.openIShotScreenshot.externalApplication)
        XCTAssertNil(AppExecutionAction.convertToICNS.externalApplication)
        XCTAssertNil(AppExecutionAction.convertToMacIcons.externalApplication)
        XCTAssertNil(AppExecutionAction.convertToIOSIcons.externalApplication)
        ...
        XCTAssertNil(AppExecutionAction.openToolboxApplication.externalApplication)
        XCTAssertNil(AppExecutionAction.translateText.externalApplication)
        XCTAssertNil(AppExecutionAction.createQRCode.externalApplication)
